...
export default function initCornerstone() {
  ...
  function elementEnabledHandler(event) {
    console.log('element has been enabled');
    const element = event.detail.element;
    element.addEventListener(cornerstone.EVENTS.IMAGE_RENDERED, imageRenderedHandler);
  }

  function elementDisabledHandler(event) {
    const element = event.detail.element;
    element.removeEventListener(cornerstone.EVENTS.IMAGE_RENDERED, imageRenderedHandler);
  }

  function imageRenderedHandler(event) {
